...
function discuss (acti) {
	$.ajax({
		url: "http://10.28.20.109:8080/gd/discuss/activityid/list.do?disc_acti_id="+acti+"&page=1&pageSize=10",
		type: 'GET',
		dataType: 'json'
	})
	.done(function(data) { 
	...
	.done(function(data) {
		$.ajax({
			...
			data: 	{
					...
					disc_user_send_id:data.user_id, //发送者id
